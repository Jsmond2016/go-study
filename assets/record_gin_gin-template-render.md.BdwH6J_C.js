import{_ as i,c as a,o as n,ae as t}from"./chunks/framework.DXW4JJKH.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"record/gin/gin-template-render.md","filePath":"record/gin/gin-template-render.md"}'),p={name:"record/gin/gin-template-render.md"};function l(h,s,e,k,E,d){return n(),a("div",null,s[0]||(s[0]=[t(`<h2 id="gin-template-render-模板渲染" tabindex="-1">gin-template-render 模板渲染 <a class="header-anchor" href="#gin-template-render-模板渲染" aria-label="Permalink to &quot;gin-template-render 模板渲染&quot;">​</a></h2><p>知识要点：</p><p>操作步骤：</p><ul><li><p>本地新建 <code>templates</code> 目录，添加以下文件</p><ul><li><code>templates/index.tmpl</code> 代码为：</li></ul><div class="language-tmpl vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">tmpl</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;html&gt;</span></span>
